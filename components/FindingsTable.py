...
class FindingsTableForm(ComponentForm):

    hideLegend = forms.BooleanField(label='Hide Severity Legend', required=False)
    field_order = ['name', 'hideLegend', 'pageBreakBefore', 'showTitle']
...
class Component(BaseComponent):
    ...
    formClass = FindingsTableForm
    fieldList = {
        'hideLegend': BoolField(templatable=True, default=False)
    }
