# Generated by Django 3.1.14 on 2026-05-18 16:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('header', writehat.models.MarkdownField(blank=True, max_length=30000, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.TextField(choices=[('active', 'Active'), ('inactive', 'Inactive'), ('draft', 'Draft')], default='active')),
                ('engagementParent', models.UUIDField(editable=False, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fieldText', models.TextField(blank=True, max_length=30000)),
        ...
        migrations.AddConstraint(
            model_name='revision',
            constraint=models.UniqueConstraint(fields=('version', 'fieldName', 'parentId'), name='Enforce Version Unique'),
        ),
    ]
